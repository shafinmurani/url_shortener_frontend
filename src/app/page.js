        ...
        {shortUrl && (
          <div className="mb-4 w-full flex justify-center">
            <Alert variant="success" className={darkStyles.success}>
              <a
                href={"https://url-shortener-ten-peach.vercel.app/url/" + shortUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="underline text-[#a5b4fc] break-all mr-4"
                style={{ maxWidth: '70%' }}
              >
                https://url-shortener-ten-peach.vercel.app/url/{shortUrl}
              </a>
              <button
                onClick={() => navigator.clipboard.writeText("https://url-shortener-ten-peach.vercel.app/url/" + shortUrl)}
